...
const tos = (
  <>
    <section>
      ...
      <p className="my-2">
        This website is operated by Samuel Jones. Throughout the site, the terms
        “we”, “us” and “our” refer to Samuel Jones. Samuel Jones offers this
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 1 - Online Store Terms</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 2 - General Conditions</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 7 - Optional Tools</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 8 - Third-Party Links</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 12 - Prohibited Uses</h3>
      <p className="my-2">
        In addition to other prohibitions as set forth in the Terms of Service,
        you are prohibited from using the site or its content:
        <ol className="pl-8 -indent-6">
    ...
    <section>
      ...
      <p className="my-2">
        ...
        us) provided &lsquo;as is&rsquo; and &lsquo;as available&rsquo; for your
      ...
      <p className="my-2">
        In no case shall Samuel Jones, our directors, officers, employees,
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 14 - Indemnification</h3>
      <p className="my-2">
        You agree to indemnify, defend and hold harmless Samuel Jones and our
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 16 - Termination</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 17 - Entire Agreement</h3>
      <p className="my-2">
    ...
    <section>
      <h3 className="text-xl font-bold mt-4">Section 18 - Governing Law</h3>
      <p className="my-2">
