...
export class IVLImageAsset extends ImageAsset {
  ...
  constructor(response: ImageResponses.NIVLResponse) {
    super(
      response.data.title,
      { orig: response.href, thumb: "" },
      response.data.description,
      response.data.date_created,
      SourceAPI.ImageAndVideoLibrary
    );
...
export class MRPImageAsset extends ImageAsset {
  ...
  constructor(response: ImageResponses.MRPResponse) {
    super(
      MRPImageAsset.getTitle(response),
      { orig: response.img_src, thumb: "" },
      MRPImageAsset.getDescription(response),
      response.earth_date,
      SourceAPI.MarsRoverPhotos
    );
